...
Qtilities::UnitTests::qti_private_DropableListWidget::qti_private_DropableListWidget(const QString& plugin_list_type, QWidget *parent) : QListView(parent) {
    setAcceptDrops(true);
    setDragEnabled(true);
...
void Qtilities::UnitTests::qti_private_DropableListWidget::mousePressEvent(QMouseEvent *event)
 {
...
void Qtilities::UnitTests::qti_private_DropableListWidget::mouseMoveEvent(QMouseEvent *event)
 {
...
void Qtilities::UnitTests::qti_private_DropableListWidget::dragEnterEvent(QDragEnterEvent *event)
 {
    if (event->mimeData()->hasFormat("text/plain"))
        event->acceptProposedAction();
 }

void Qtilities::UnitTests::qti_private_DropableListWidget::dropEvent(QDropEvent *event) {
    if (event) {
