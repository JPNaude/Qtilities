...
void Qtilities::UnitTests::TestSubjectIterator::testIterationSimpleFromMiddle() {
    TreeNode node;
    node.addItem("1");
...
void Qtilities::UnitTests::TestSubjectIterator::testIterationComplex() {
    TreeNode node;
...
void Qtilities::UnitTests::TestSubjectIterator::testIterationObserverWithoutChildren() {
...
void Qtilities::UnitTests::TestSubjectIterator::testIterationConst() {
    TreeNode* node = new TreeNode;
    node->addItem("1");
    node->addItem("2");
    node->addItem("3");
