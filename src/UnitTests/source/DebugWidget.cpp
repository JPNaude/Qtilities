...
struct Qtilities::UnitTests::DebugWidgetPrivateData {
...
Qtilities::UnitTests::DebugWidget::DebugWidget(QWidget *parent) :
    QMainWindow(parent),
...
Qtilities::UnitTests::DebugWidget::~DebugWidget()
{
    #ifdef QTILITIES_CONAN
...
QWidget* Qtilities::UnitTests::DebugWidget::modeWidget() {
    return this;
}

QIcon Qtilities::UnitTests::DebugWidget::modeIcon() const {
    return QIcon(qti_icon_DEBUG_48x48);
}

QString Qtilities::UnitTests::DebugWidget::modeName() const {
    return tr("Qtilities Debugging");
}

void Qtilities::UnitTests::DebugWidget::aboutToBeActivated() {
    on_btnRefreshViews_clicked();
}

void Qtilities::UnitTests::DebugWidget::finalizeMode() {
...
void Qtilities::UnitTests::DebugWidget::handle_factoryListSelectionChanged(const QString& factory_name) {
    ui->listFactoryItemIDs->clear();
    ui->listFactoryItemIDs->addItems(OBJECT_MANAGER->tagsForFactory(factory_name));
}

void Qtilities::UnitTests::DebugWidget::handle_objectPoolDoubleClick(QObject *object) {
    Q_UNUSED(object)
}

void Qtilities::UnitTests::DebugWidget::handle_objectPoolSelectionChanged(QList<QObject*> objects) {
    if (objects.count() == 1) {
...
void Qtilities::UnitTests::DebugWidget::changeEvent(QEvent *e)
{
...
void Qtilities::UnitTests::DebugWidget::on_btnRefreshViews_clicked() {
    // ===============================
    // Refresh Plugins:
    // ===============================
...
void Qtilities::UnitTests::DebugWidget::on_btnExplorePluginConfigSetPath_clicked()
{
...
bool Qtilities::UnitTests::DebugWidget::on_btnSavePluginConfigSet_clicked()
{
...
bool Qtilities::UnitTests::DebugWidget::on_btnSaveNewPluginConfigSet_clicked()
{
...
void Qtilities::UnitTests::DebugWidget::on_btnEditPluginConfigSet_clicked()
{
    if (ui->txtPluginsActiveSet->text().isEmpty())
        return;
...
void Qtilities::UnitTests::DebugWidget::on_btnExplorePluginCurrentConfigSetPath_clicked()
{
    if (ui->txtPluginsActiveSet->text().isEmpty())
        return;
...
void Qtilities::UnitTests::DebugWidget::on_btnEditPluginCurrentConfigSet_clicked()
{
    if (ui->txtPluginsActiveSet->text().isEmpty())
        return;
...
void Qtilities::UnitTests::DebugWidget::on_btnOpenPluginConfigSet_clicked()
{
...
void Qtilities::UnitTests::DebugWidget::on_btnRemoveActivePlugin_clicked()
{
    d->active_plugins_model.removeRow(d->active_plugins_view->currentIndex().row());
}

void Qtilities::UnitTests::DebugWidget::on_btnAddActivePlugin_clicked()
{
    bool ok;
...
void Qtilities::UnitTests::DebugWidget::on_btnRemoveInactivePlugin_clicked()
{
    d->inactive_plugins_model.removeRow(d->inactive_plugins_view->currentIndex().row());
}

void Qtilities::UnitTests::DebugWidget::on_btnAddInactivePlugin_clicked()
{
    bool ok;
...
void Qtilities::UnitTests::DebugWidget::on_btnRemoveFilterExpression_clicked()
{
    d->filtered_plugins_model.removeRow(d->filtered_plugins_view->currentIndex().row());
}

void Qtilities::UnitTests::DebugWidget::on_btnAddFilterExpression_clicked()
{
    bool ok;
...
void Qtilities::UnitTests::DebugWidget::handleListMessage(Logger::MessageType type, const QString& msg) {
...
void Qtilities::UnitTests::DebugWidget::on_btnContextSetActive_clicked()
{
...
void Qtilities::UnitTests::DebugWidget::on_btnContextsClear_clicked()
{
    CONTEXT_MANAGER->setNewContext(Qtilities::Core::Constants::qti_def_CONTEXT_STANDARD);
    refreshContexts();
    refreshCommandInformation();
...
void Qtilities::UnitTests::DebugWidget::on_btnContextsBroadcast_clicked()
{
    CONTEXT_MANAGER->broadcastState();
    refreshContexts();
}

void Qtilities::UnitTests::DebugWidget::refreshModes() {
    ui->tableModes->clear();
...
void Qtilities::UnitTests::DebugWidget::refreshContexts() {
...
void Qtilities::UnitTests::DebugWidget::refreshCommandInformation() {
...
void Qtilities::UnitTests::DebugWidget::refreshCurrentPluginState() {
...
void Qtilities::UnitTests::DebugWidget::refreshCurrentPluginSet() {
...
void Qtilities::UnitTests::DebugWidget::refreshEditedPluginState() {
...
void Qtilities::UnitTests::DebugWidget::refreshFactories() {
    ui->listFactoryItemIDs->clear();
...
void Qtilities::UnitTests::DebugWidget::on_btnAnalyzeCurrentObject_clicked()
{
    #ifdef QTILITIES_CONAN
    if (d->current_object) {
        if (!d->object_analysis_widget) {
...
void Qtilities::UnitTests::DebugWidget::on_btnAnalyzeAction_clicked()
{
    #ifdef QTILITIES_CONAN
    if (d->current_command) {
        if (!d->command_analysis_widget) {
...
void Qtilities::UnitTests::DebugWidget::on_chkRefreshProperties_toggled(bool checked)
{
    Q_UNUSED(checked)
...
QString Qtilities::UnitTests::DebugWidget::objectAddress(QObject* obj) const {
    return QString ("0x%1").arg (reinterpret_cast <quintptr> (obj), sizeof(quintptr)*2, 16, QChar('0'));
}

void Qtilities::UnitTests::DebugWidget::on_btnProjectsCurrentOpenPath_clicked()
{
...
void Qtilities::UnitTests::DebugWidget::on_btnProjectsCurrentOpenFile_clicked()
{
    if (ui->txtProjectsCurrentFileName->text().isEmpty())
        return;
...
void Qtilities::UnitTests::DebugWidget::refreshProjectsState() {
