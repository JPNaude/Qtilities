...
int Qtilities::UnitTests::TestNamingPolicyFilter::execTest(int argc, char ** argv) {
    return QTest::qExec(this,argc,argv);
}

void Qtilities::UnitTests::TestNamingPolicyFilter::testPropertyManagement() {
...
void Qtilities::UnitTests::TestNamingPolicyFilter::testSetUniquenessPolicies() {
    TreeNode node;
...
void Qtilities::UnitTests::TestNamingPolicyFilter::testRejectUniquenessResolutionPolicy() {
    TreeNode node;
...
void Qtilities::UnitTests::TestNamingPolicyFilter::testAutoRenameUniquenessResolutionPolicy() {
    TreeNode node;
...
void Qtilities::UnitTests::TestNamingPolicyFilter::testRejectValidityResolutionPolicy() {
    TreeNode node;
...
void Qtilities::UnitTests::TestNamingPolicyFilter::testProcessingCycleValidationChecks() {
    TreeNode node;
    ...
    filter->setProcessingCycleValdiationChecks(NamingPolicyFilter::NoChecks);
    ...
    filter->setProcessingCycleValdiationChecks(NamingPolicyFilter::Validity);
    node.addItem("");
    QVERIFY(node.subjectCount() == 2);
    node.addItem("A");
    QVERIFY(node.subjectCount() == 3);

    filter->setProcessingCycleValdiationChecks(NamingPolicyFilter::Uniqueness);
