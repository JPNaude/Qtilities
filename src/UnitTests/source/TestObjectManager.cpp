...
int Qtilities::UnitTests::TestObjectManager::execTest(int argc, char ** argv) {
    return QTest::qExec(this,argc,argv);
}

void Qtilities::UnitTests::TestObjectManager::testCloneAndRemoveDynamicProperties() {
...
void Qtilities::UnitTests::TestObjectManager::testCompareDynamicProperties() {
...
void Qtilities::UnitTests::TestObjectManager::testCompareDynamicPropertiesDiff() {
    QObject* obj1 = new QObject;
    obj1->setObjectName("Object1");
    QObject* obj2 = new QObject;
    obj2->setObjectName("Object2");
...
void Qtilities::UnitTests::TestObjectManager::testMoveSubjects() {
