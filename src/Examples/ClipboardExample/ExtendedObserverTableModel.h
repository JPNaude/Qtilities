...
#ifndef EXTENDEDOBSERVERTABLEMODEL_H
#define EXTENDEDOBSERVERTABLEMODEL_H
...
namespace Qtilities {
    namespace Examples {
        namespace Clipboard {
            ...
            */
            class ExtendedObserverTableModel : public AbstractObserverTableModel
            {
                Q_OBJECT

            public:
                ExtendedObserverTableModel(QObject* parent = 0);
                ~ExtendedObserverTableModel() {}
...
#endif // EXTENDEDOBSERVERTABLEMODEL_H
