...
namespace Qtilities {
    namespace CoreGui {
        ...
        /*!
        \struct AbstractObserverTableModelData
        \brief Structure used by AbstractObserverTableModel to store private data.
          */
        struct AbstractObserverTableModelData;

        //! The AbstractObserverTableModel class provides an ready-to-use model that can be used to show the contents of an Observer in a QTableView.
        /*!
          The AbstractObserverTableModel class provides an ready-to-use model that can be used to show and manage the contents of an Observer in a QTableView.
          ...
          of subjects attached to a specific observer in a QTableView. AbstractObserverTableModel has knowledge of the standard subject filters which
          ...
          When you develop your own subject filters and want to make information controlled by these filters visible through AbstractObserverTableModel,
          you would need to subclassing from AbstractObserverTableModel and implement the needed virtual functions.
        */
        class QTILITIES_CORE_GUI_SHARED_EXPORT AbstractObserverTableModel : virtual public QAbstractTableModel, public AbstractObserverItemModel
        {
            Q_OBJECT

        public:
            AbstractObserverTableModel(QObject* parent = 0);
        ...
        protected:
            AbstractObserverTableModelData* d;
        };
    }
}
