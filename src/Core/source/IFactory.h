...
namespace Qtilities {
    namespace Core {
        namespace Interfaces {
            ...
            /*!
              \struct IFactoryTag
              \brief The IFactoryTag struct contains all the information required to create an instance through the
                Qtilities::Core::Interfaces::IObjectManager::createInstance() method.
